(function (global, factory) {
    ...
    (global = global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.messaging = {}), global.ng.core, global.firebase, global.rxjs, global.rxjs.operators, global.angular.fire, global.ng.common));
    ...
    var AngularFireMessaging = /** @class */ (function () {
        ...
        platformId, zone) {
             ...
             * @param {?} messaging
             * @return {?}
             */ messaging) { return firebase.messaging.isSupported() ? messaging.requestPermission() : rxjs.throwError('Not supported.'); })));
             ...
             * @param {?} messaging
             * @return {?}
             */ messaging) { return firebase.messaging.isSupported() && Notification.permission === 'granted' ? messaging.getToken() : rxjs.EMPTY; })), operators.defaultIfEmpty(null));
            /** @type {?} */
             ...
             * @param {?} messaging
             * @return {?}
             */ messaging) { return firebase.messaging.isSupported() ? new rxjs.Observable(( /**
             * @param {?} emitter
             * @return {?}
             */function (/**
             * @param {?} emitter
             ...
             * @param {?} messaging
             * @return {?}
             */ messaging) { return firebase.messaging.isSupported() ? rxjs.concat(_this.getToken, tokenChanges) : rxjs.EMPTY; })));
