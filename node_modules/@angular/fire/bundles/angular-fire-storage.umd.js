(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/fire'), require('firebase/storage'), require('firebase/app'), require('@firebase/storage')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/storage', ['@angular/core','exports', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/fire', 'firebase/storage', 'firebase/app', '@firebase/storage'], factory) :
    (global = global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.storage = {}), global.rxjs, global.rxjs.operators, global.ng.core, global.angular.fire, null, global.firebase, global['firebase-storage']));
}(this, (function (ɵngcc0,exports, rxjs, operators, i0, i1, storage, firebase, storage$1) { 'use strict';
