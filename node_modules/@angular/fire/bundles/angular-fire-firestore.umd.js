(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/common'), require('firebase/firestore'), require('firebase/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/firestore', ['@angular/core','exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/common', 'firebase/firestore', 'firebase/app'], factory) :
    (global = global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.firestore = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.ng.common, null, global.firebase));
}(this, (function (ɵngcc0,exports, i0, rxjs, operators, i1, common, firestore, firebase) { 'use strict';
