(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('firebase/database'), require('@firebase/database'), require('firebase/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/database', ['@angular/core','exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', 'firebase/database', '@firebase/database', 'firebase/app'], factory) :
    (global = global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.database = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, null, global['firebase-database'], global.firebase));
}(this, (function (ɵngcc0,exports, i0, rxjs, operators, i1, database, database$1, firebase) { 'use strict';
